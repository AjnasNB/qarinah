/* eslint-disable */
// Generated by Wrangler by running `wrangler types .\worker-configuration.d.ts` (hash: d8d733b22ead77def602accf8f04e5d3)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	ACTIVATION: AnalyticsEngineDataset;
	ASSETS: Fetcher;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./website/worker");
	}
