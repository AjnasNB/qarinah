...
```sh
python scripts/build-whitepaper-pdf-v1.8.py
```

The v1.8 source receipt binds `docs/WHITEPAPER.md`, the shared layout engine, and the v1.4 through v1.8 wrappers. Its companion build metadata records the Python, ReportLab, platform, and font inputs used for that generated artifact. v1.3 through v1.7 remain immutable historical artifacts; never run a historical builder to replace an existing PDF.
