...
assert.equal(receipt.amendmentsSha256AtFreeze, sha256(amendments));
...
assert.ok(amendments.includes("No amendments have been made."));
...
assert.equal(packageJson.scripts["check:research-protocol"], "node scripts/verify-final-protocol-v1.mjs");
