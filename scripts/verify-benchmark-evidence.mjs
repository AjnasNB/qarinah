...
const softwareTaskPath = path.join(root, "bench", "results", "software-task-context-0.1.0.json");
const softwareTask = JSON.parse(await readFile(softwareTaskPath, "utf8"));
const longDocumentPath = path.join(root, "bench", "results", "long-document-context-0.1.0.json");
