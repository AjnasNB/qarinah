...
const INITIALIZE_LOCK_NAME = "initialize";
const INITIALIZE_LOCK_TIMEOUT_MS = 15_000;
...
export async function initializeWorkspace(target = process.cwd(), options = {}) {
  ...
  try {
    ...
    // Config is the readiness marker and is deliberately written last. Other
    // workers cannot discover a workspace until its storage and local permit
    // are complete.
