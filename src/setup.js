...
async function installSkill(workspace, host) {
  ...
  const sourceRoot = path.join(PACKAGE_ROOT, "integrations", host, "qarinah", "skills", "qarinah-context");
  for (const relative of ["SKILL.md", path.join("references", "event-contract.md")]) {
