...
```powershell
claude plugin marketplace add AjnasNB/qarinah@v0.1.4 --scope project
claude plugin install qarinah@qarinah --scope project

# Or keep the enablement personal to this repository.
claude plugin marketplace add AjnasNB/qarinah@v0.1.4 --scope local
...
claude plugin marketplace add AjnasNB/qarinah@v0.1.4
