#!/usr/bin/env node
// GENERATED by scripts/build-plugins.mjs for Qarinah 0.5.0-rc.1. DO NOT EDIT.
...
// src/version.js
var QARINAH_VERSION = "0.5.0-rc.1";
...
function normalizedOptions(options) {
  ...
  const allowed = /* @__PURE__ */ new Set(["cwd", "query", "includeWorktrees", "limit", "clock"]);
  const unknown = Object.keys(options).filter((key) => !allowed.has(key));
