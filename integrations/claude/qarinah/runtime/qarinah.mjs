...
${projects.map((project) => `<a class="project" href="${escapeHtml2(project.href)}" data-project="${escapeHtml2(project.workspaceId)}"><h2>${escapeHtml2(project.branch ?? project.name)}</h2><div>${escapeHtml2(project.root)}</div><dl><dt>Repository</dt><dd><code>${escapeHtml2(project.repositoryId ?? "not-git")}</code></dd><dt>Worktree</dt><dd><code>${escapeHtml2(project.worktreeId ?? "not-git")}</code></dd><dt>Commit</dt><dd><code>${escapeHtml2(project.commit?.slice(0, 12) ?? "unborn")}</code></dd><dt>Workspace</dt><dd><code>${escapeHtml2(project.workspaceId)}</code></dd><dt>Events</dt><dd data-events>Loading\u2026</dd><dt>Last activity</dt><dd data-activity>Loading\u2026</dd></dl></a>`).join("")}
</div></main><script>
